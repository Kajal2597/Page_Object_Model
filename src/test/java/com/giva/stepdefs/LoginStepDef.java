...
public class LoginStepDef {
    ...
    public void i_am_on_the_giva_co_login_page() {
    ...
    public void i_have_entered_a_valid_username_and_password() {
        loginPage.login("kajalg2597@gmail.com","Kajal@2001");
    }

    @Given("I have entered invalid {string} and {string}")
    public void i_have_entered_invalid_and(String username, String password) {
        loginPage.login("kk@gmail.com","kajal11");
    }
    ...
    public void i_should_see_an_error_message_indicating(String errorMessage) {
        ...
        Assert.assertEquals( driver.findElement(By.cssSelector("div[class='errors'] ul li")).isDisplayed(), true);
    }
}